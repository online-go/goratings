...
from .cli import cli
from .rating2rank import configure_rating_to_rank
...
glicko2_config.add_argument('--max-rd', dest='max_rd', type=float, default=500.0, help='maximum rating deviation')

def configure_glicko2(args):
    glicko2_configure(
        tao = args.tao,
        min_rd = args.min_rd,
        max_rd = args.max_rd,
